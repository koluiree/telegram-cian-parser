...
async def help(update, context):
    await update.message.reply_text('Для начала тебе нужно задать мне настройки:\n'
                                    '/city <город> - указываешь город, в котором хочешь посмотреть недвижимость (по умолчанию Москва)\n'
                                    ...
                                    'Пример: /city Анапа\n/rooms 3\n'
                                    'P.S.: если вы введете минимальное значение цены больше максимального - фильтр просто не сработает\n'
